 ...
 */
public class MessagingFragment extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mleerButton = (Button) rootView.findViewById(R.id.leer);
        mleerButton.setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (view == mSendSingleConversation) {
            ...
            mDataPortView.setText(MessageLogger.getAllMessages(getActivity()));
        } else if (view == mleerButton) {
            textToSpeech.setLanguage(Locale.ENGLISH);
            speak(mDataPortView.getText().toString());
